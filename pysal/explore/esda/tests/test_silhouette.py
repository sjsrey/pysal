...
RTOL = pysal.lib.common.RTOL
ATOL = pysal.lib.common.ATOL

class Silhouette_Tester(unittest.TestCase):
    def setUp(self):
        self.w = pysal.lib.weights.lat2W(3,3, rook=False)
        numpy.random.seed(12345)
        self.X = numpy.random.random((9,3))
        self.groups = numpy.array([[0,0,0],
                                   [0,1,1],
                                   [0,1,1]]).flatten()
    ...
    def test_path(self):
        ...
        with self.assertRaises(AssertionError):
            silhouettes.path_silhouette(self.X, self.groups, self.w,
                                         metric=lambda d: -self.altmetric(d))
    ...
    def test_silhouette_alist(self):
        known = numpy.array([ 0.        ,  0.        ,  0.22434244,  0.        ,
                             -0.07589293,  0.        , -0.07589293,  0.        ,
                              0.        ,  0.41331324,  0.41331324,  0.        ,
                              0.        ,  0.        ,  0.11703681,  0.11703681,
                              0.27065991,  0.27065991,  0.27065991,  0.27065991,
                              0.        ,  0.        ,  0.        ,  0.27065991,
                             -0.07441639, -0.07441639,  0.        ,  0.        ,
                              0.        ,  0.        ,  0.41576712,  0.41576712,
                             -0.06657343,  0.        ,  0.        , -0.06657343,
                              0.        ,  0.        ,  0.        ,  0.        ])
