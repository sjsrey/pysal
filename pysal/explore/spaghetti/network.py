...
class Network:
    ...
    w_components : bool
        ...
        ``pysal.lib.weights.W`` object. Default is ``True``.
    ...
    def contiguityweights(self, graph=True, weightings=None):
        """Create a contiguity-based ``pysal.lib.weights.W`` object.
        
        Parameters
        ----------
        
        graph : bool
            Controls whether the ``pysal.lib.weights.W`` is generated
        ...
        `pysal.explore.esda <https://pysal.explore.esda.readthedocs.io/en/latest/index.html>`_ 
        ...
        `pysal.explore.esda.Moran <https://pysal.explore.esda.readthedocs.io/en/latest/generated/pysal.explore.esda.Moran.html#pysal.explore.esda.Moran>`_ 
        ...
        See :cite:`pysal2007` and :cite:`pysal.explore.esda:_2019` for more details.
    ...
    def distancebandweights(self, threshold, n_processes=1, gen_tree=False):
        ...
        `US feet in this case <https://github.com/pysal/pysal.lib/blob/master/pysal.lib/examples/geodanet/streets.prj>`_.
